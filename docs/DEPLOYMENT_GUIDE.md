...
4. Settings:
   - **Root Directory**: `.` *(Leave this blank or set to `.` — do NOT set to `backend`. Render must clone the entire repository to access the `ml/` directory)*
   - **Docker Build Context**: `.` *(if prompted)*
