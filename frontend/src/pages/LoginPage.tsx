...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div
      className={`relative min-h-screen w-screen flex items-center justify-center p-4 sm:p-6 overflow-x-hidden font-sans transition-colors duration-200 ${isDark ? 'bg-[#050811] text-slate-100' : 'bg-slate-100 text-slate-900'
        }`}
    >
      ...
      <div className="absolute top-4 right-4 z-30">
        <button
          onClick={toggleTheme}
          className={`flex items-center gap-2 px-3.5 py-1.5 rounded-full border text-xs font-semibold backdrop-blur-md transition-all shadow-md cursor-pointer ${isDark
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          className={`absolute -top-[20%] -left-[10%] w-[600px] h-[600px] rounded-full blur-[140px] ${isDark ? 'bg-cyan-900/15' : 'bg-sky-200/50'
            }`}
        />
        <div
          className={`absolute -bottom-[20%] -right-[10%] w-[700px] h-[700px] rounded-full blur-[160px] ${isDark ? 'bg-blue-900/15' : 'bg-blue-200/40'
            }`}
        />
        <div
          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full blur-[180px] ${isDark ? 'bg-sky-950/20' : 'bg-cyan-100/60'
            }`}
        />

        {/* Tactical Radar Concentric Circles */}
        <div
          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] rounded-full border ${isDark ? 'border-cyan-500/5' : 'border-sky-500/10'
            }`}
        />
        <div
          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[650px] rounded-full border ${isDark ? 'border-cyan-500/10' : 'border-sky-500/15'
            }`}
        />
        <div
          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full border ${isDark ? 'border-cyan-500/15' : 'border-sky-500/20'
            }`}
        />
      ...
      <div className="relative z-10 w-full max-w-5xl flex flex-col items-center">
        ...
        <div className="text-center mb-6 space-y-2">
          <div
            className={`inline-flex items-center gap-2.5 px-3 py-1.5 rounded-full border text-xs font-mono mb-1 ${isDark
          ...
          <div className="flex items-center justify-center gap-3">
            <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-sky-500 to-cyan-600 p-0.5 shadow-lg shadow-sky-500/20">
              <div
                className={`w-full h-full rounded-[10px] flex items-center justify-center ${isDark ? 'bg-[#080d1a]' : 'bg-white'
                  }`}
              >
            ...
            <h1
              className={`text-3xl sm:text-4xl font-extrabold tracking-tight ${isDark
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div
            className={`lg:col-span-5 flex flex-col justify-between p-5 sm:p-6 rounded-2xl border backdrop-blur-xl space-y-4 ${isDark
          ...
          >
            <div className="space-y-1.5">
              <div
                className={`flex items-center gap-2 text-xs font-semibold uppercase tracking-wider ${isDark ? 'text-cyan-400' : 'text-sky-700'
                  }`}
              >
              ...
              {DEMO_ROLES.map((role) => {
                ...
                return (
                  <button
                    ...
                    disabled={submitting}
                    className={`w-full flex items-center justify-between p-3.5 rounded-xl border transition-all text-left group cursor-pointer disabled:opacity-50 ${isDark
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div
                        className={`w-9 h-9 rounded-lg border flex items-center justify-center transition-all shrink-0 ${isDark
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          <span
                            className={`text-xs font-bold truncate transition-colors ${isDark ? 'text-slate-100 group-hover:text-cyan-300' : 'text-slate-950 group-hover:text-sky-700'
                              }`}
                          >
                            {role.name}
                          </span>
                    ...
                    <div className="shrink-0 flex items-center gap-1.5 pl-2">
                      <span
                        className={`text-[10px] font-mono opacity-0 group-hover:opacity-100 transition-opacity font-bold hidden sm:inline ${isDark ? 'text-cyan-400' : 'text-sky-700'
                          }`}
                      >
                        Sign In
                      </span>
                      <ArrowRight
                        className={`w-3.5 h-3.5 group-hover:translate-x-0.5 transition-all ${isDark ? 'text-slate-600 group-hover:text-cyan-400' : 'text-slate-400 group-hover:text-sky-600'
                          }`}
                      />
                    </div>
                  </button>
            ...
            <div
              className={`p-3.5 rounded-xl border text-xs font-mono space-y-2 ${isDark
            ...
            >
              <div className="flex items-center justify-between">
                <span
                  className={`flex items-center gap-1.5 font-semibold text-[11px] ${backendOnline
                ...
                <span
                  className={`text-[10px] px-1.5 py-0.5 rounded border font-semibold ${backendOnline
                      ? isDark
              ...
              <div
                className={`grid grid-cols-2 gap-2 text-[10px] pt-1 border-t ${isDark ? 'text-slate-400 border-slate-800' : 'text-slate-600 border-slate-200'
                  }`}
              >
          ...
          <div
            className={`lg:col-span-7 p-6 sm:p-8 rounded-2xl border backdrop-blur-xl flex flex-col justify-between space-y-5 ${isDark
          ...
          >
            ...
            <div className={`flex items-center justify-between border-b pb-4 ${isDark ? 'border-slate-800' : 'border-slate-200'}`}>
              <div
                className={`flex items-center gap-2 p-1 rounded-lg border ${isDark ? 'bg-slate-900/90 border-slate-800' : 'bg-slate-100 border-slate-200'
                  }`}
              >
                <button
                  type="button"
                  ...
                  className={`px-4 py-1.5 rounded-md text-xs font-bold transition-all cursor-pointer ${mode === 'login'
                      ? isDark
                ...
                <button
                  ...
                  className={`px-4 py-1.5 rounded-md text-xs font-bold transition-all cursor-pointer ${mode === 'register'
                      ? isDark
                        ? 'bg-cyan-500 text-slate-950 shadow-sm'
                        : 'bg-sky-600 text-white shadow-sm'
                      : isDark
            ...
            {authError && (
              <div
                className={`p-3 rounded-lg border text-xs flex items-start gap-2.5 animate-in fade-in ${isDark
            ...
            {mode === 'login' ? (
              <form onSubmit={handleLoginSubmit} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className={`w-full px-3.5 py-2.5 rounded-lg border text-xs transition-all font-mono outline-none shadow-sm ${isDark
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-3.5 py-2.5 rounded-lg border text-xs transition-all font-mono outline-none pr-10 shadow-sm ${isDark
                          ? 'bg-slate-900/90 border-slate-700/80 focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 text-slate-100 placeholder:text-slate-600'
                          : 'bg-white border-slate-300 focus:border-sky-600 focus:ring-2 focus:ring-sky-500/20 text-slate-950 placeholder:text-slate-400'
                        }`}
                    />
                    <button
                      ...
                      className={`absolute right-3 top-1/2 -translate-y-1/2 transition-colors cursor-pointer ${isDark ? 'text-slate-400 hover:text-slate-200' : 'text-slate-400 hover:text-slate-700'
                        }`}
                    >
                ...
                <div className={`flex items-center justify-between text-xs pt-1 ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
                  <label className="flex items-center gap-2 cursor-pointer select-none">
                    <input
                      type="checkbox"
                      defaultChecked
                      className={`rounded focus:ring-0 w-3.5 h-3.5 ${isDark
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className={`w-full mt-2 py-3 px-4 rounded-xl font-bold text-xs tracking-wider uppercase transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 ${isDark
              ...
              <form onSubmit={handleRegisterSubmit} className="space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 rounded-lg border text-xs outline-none shadow-sm ${isDark
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 rounded-lg border text-xs outline-none font-mono shadow-sm ${isDark
                          ? 'bg-slate-900/90 border-slate-700/80 focus:border-cyan-400 text-slate-100 placeholder:text-slate-600'
                          : 'bg-white border-slate-300 focus:border-sky-600 text-slate-950 placeholder:text-slate-400'
                        }`}
                    />
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className={`w-full mt-3 py-2.5 px-4 rounded-xl font-bold text-xs tracking-wider uppercase transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 ${isDark
